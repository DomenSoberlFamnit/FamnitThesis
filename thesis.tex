...
% \input{licenca.tex} % Slovene version
% \input{license.tex} & English version
...
\begin{document}
    % Thesis chapters.
    \input{uvod.tex}
    \input{tehnicni-predpisi.tex}
    \input{metodologija.tex}

    \backmatter % Stop counting pages here.
